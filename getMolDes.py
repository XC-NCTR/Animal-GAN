...
if __name__ == '__main__':
    ...
    SDFs = os.listdir(os.path.join(path,'SDFs'))
    mols_3d = [Chem.MolFromMolFile(os.path.join(path,'SDFs','{}'.format(sdf))) for sdf in SDFs]
    ...
    #df = calc.pandas(mols_3d)
    df.to_csv(os.path.join(path,'MolDescriptors.tsv'), sep='\t')
